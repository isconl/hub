...
module.exports = {
  ...
  capabilities: [
    ...
    { name: 'hub.services', method: 'GET', path: '/services', description: 'Every named service the owner runs (isconl engines and otherwise), with live status where available.' },
