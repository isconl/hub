...
const ROUTES = [
  ...
  // FN26082702: the webconsole's jiraPanel review-then-push UI (app.js's
  ...
  // Sconl's own already-authenticated webconsole session reach the gate
  // that already exists.
  ...
  // calling this verb; the webconsole (server.js's real handler above)
