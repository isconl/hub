...
const ROUTES = [
  ...
  // -- vault: /api/auth/totp and /api/auth/pin are handled directly in
  // server.js (public, same handler as hub's own /auth/totp and /auth/pin)
  ...
  { method: 'GET', path: '/api/auth/methods', legacy: true },
