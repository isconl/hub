...
const ROUTES = [
  ...
  // /api/insights: rebuilt natively in server.js (calls vault's onThisDay,
  // reshapes into {insights:{calendar:{...}}}) -- checked before this
  // table is ever consulted, same pattern as /api/state, so it's not
  // listed here even though the route exists. Fixed 2026-08-16: pulse's
  // "calendar" card was a permanently-hardcoded placeholder
  // (pulse/lib/rhythm.js's DEFAULT_INSIGHTS, "On August 1, 1971, the
  // Concert for Bangladesh...") that nothing had ever replaced.
